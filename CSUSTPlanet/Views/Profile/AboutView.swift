...
开发长理星球的初衷是为了让同学们能够更加便捷地使用学校的教务系统和网络课程中心。当前版本已经实现了以下功能：

- 教务系统方面：提供方便的成绩查询、考试安排查看以及课表查询服务
- 网络课程中心：提供课程列表查看功能（注：暑假期间学校会关闭外网访问）
- 其他实用功能：未做作业提醒、宿舍电量查询和定时通知、校园地图导航、校历查看，以及快速进入四六级/普通话查询网站的快捷入口
...
未来版本将会继续完善功能，包括开发实用的小组件等，持续提升用户体验。

## 特别致谢

在开发过程中，我要特别感谢以下个人和团队的支持与帮助：

BobH开发的i乐学助手为长理星球提供了部分功能与设计灵感，他的GitHub主页是[https://github.com/BobH233](https://github.com/BobH233)。长沙理工大学拓扑实验室的同学们给了我很多技术上的启发，让我遇到了许多编程高手。同时也要感谢CreaMakers团队的所有成员，在这个充满创造力的团队中，我获得了许多成长与进步。
